...
-(void)jiekou
{
    ...
    NSDictionary*datadic=[NSDictionary dictionaryWithObjectsAndKeys:vip,@"vipId",@"1",@"pageNo",@"5",@"pageSize",nil];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *id1 =@"zhongjiangjilu";
    ...
    kaishi.text = [NSString stringWithFormat:@"中奖时间:%@",[[arr[indexPath.row] objectForKey:@"couponInfo"] objectForKey:@"startTime"]];
    ...
    jieshu.text = [NSString stringWithFormat:@"有  效  期:%@",[[arr[indexPath.row] objectForKey:@"couponInfo"] objectForKey:@"endTime"]];
