...
- (void)viewDidLoad {
    ...
    [self.ratingBar1 setImageDeselected:@"star_dark.png" halfSelected:nil fullSelected:@"star_light.png" andDelegate:self];
    ...
    [self.ratingBar2 setImageDeselected:@"star_dark.png" halfSelected:nil fullSelected:@"star_light.png" andDelegate:self];
    ...
    [self.ratingBar3 setImageDeselected:@"star_dark.png" halfSelected:nil fullSelected:@"star_light.png" andDelegate:self];
