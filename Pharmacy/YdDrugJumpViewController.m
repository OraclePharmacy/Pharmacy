...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    biaoshi.frame = CGRectMake(110, 25, width - 115, 20);
    biaoshi.font = [UIFont systemFontOfSize:12];
    biaoshi.textColor = [UIColor colorWithHexString:@"646464" alpha:1];
    if ([[arr[indexPath.row] objectForKey:@"prescription"] isEqualToString:@"0"]) {
        biaoshi.text = @"标识:非处方";
    }else{
        biaoshi.text = @"标识:处方";
    }
    ...
    changjia.frame = CGRectMake(110, 65, width - 115, 20);
    ...
    jianjie.frame = CGRectMake(110, 85, width  - 115, 20);
    jianjie.font = [UIFont systemFontOfSize:12];
    jianjie.text=[NSString stringWithFormat:@"简介:%@",[arr[indexPath.row] objectForKey:@"summary"]];
    ...
    [cell.contentView addSubview:guige];
    [cell.contentView addSubview:changjia];
    [cell.contentView addSubview:biaoshi];
    [cell.contentView addSubview:jianjie];
