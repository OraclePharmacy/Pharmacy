...
//        if (NULL == [_yaopin[indexPath.row] objectForKey:@"specification"]) {
//            name.text = @"";
//        }
//        else{
...
//        if (NULL == [_yaopin[indexPath.row] objectForKey:@"manufacturer"]) {
//            name.text = @"";
//        }
//        else{
...
//        if (NULL == [_yaopin[indexPath.row] objectForKey:@"summary"]) {
//            name.text = @"药品简介:";
//        }
//        else{
...
//        [cell.contentView addSubview:xian];
        ...
        changjia.textColor = [UIColor colorWithHexString:@"646464" alpha:1];
        changjia.text = [NSString stringWithFormat:@"生产厂家:%@",[_yaopin[indexPath.row] objectForKey:@"manufacturer"]];
        
        UILabel *guige = [[UILabel alloc]init];
        guige.frame = CGRectMake(110, 45, width - 115, 20);
        guige.font = [UIFont systemFontOfSize:12];
        guige.textColor = [UIColor colorWithHexString:@"646464" alpha:1];
        guige.text = [NSString stringWithFormat:@"规格:%@",[_yaopin[indexPath.row] objectForKey:@"specification"]];
